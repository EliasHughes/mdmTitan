        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAuthenticatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceCredentials_Organizations_OrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceCredentials_OrganizationId_IsActive",
                table: "DeviceCredentials",
                columns: new[] { "OrganizationId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_DeviceCredentials_SecretHash",
                table: "DeviceCredentials",
                column: "SecretHash",
                unique: true);
        }
