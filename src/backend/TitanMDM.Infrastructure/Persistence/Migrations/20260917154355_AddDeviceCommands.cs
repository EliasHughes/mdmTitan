        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceCommands_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceCommands_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceCommands_CreatedByUserId",
                table: "DeviceCommands",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceCommands_DeviceId_Status_CreatedAtUtc",
                table: "DeviceCommands",
                columns: new[] { "DeviceId", "Status", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_DeviceCommands_ExpiresAtUtc",
                table: "DeviceCommands",
                column: "ExpiresAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceCommands_OrganizationId_DeviceId_Status",
                table: "DeviceCommands",
                columns: new[] { "OrganizationId", "DeviceId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_DeviceCommands_OrganizationId_Status_CreatedAtUtc",
                table: "DeviceCommands",
