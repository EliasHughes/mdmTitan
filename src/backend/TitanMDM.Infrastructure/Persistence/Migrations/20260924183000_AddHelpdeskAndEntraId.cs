...
public partial class AddHelpdeskAndEntraId : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(name: "IX_HelpdeskQueues_OrganizationId_Name", table: "HelpdeskQueues", columns: new[] { "OrganizationId", "Name" }, unique: true);
        migrationBuilder.CreateIndex(name: "IX_EntraIdSettings_OrganizationId", table: "EntraIdSettings", column: "OrganizationId", unique: true);
        migrationBuilder.CreateIndex(name: "IX_EntraDirectoryUsers_OrganizationId_EntraObjectId", table: "EntraDirectoryUsers", columns: new[] { "OrganizationId", "EntraObjectId" }, unique: true);
        migrationBuilder.CreateIndex(name: "IX_EntraDirectoryUsers_LinkedTitanUserId", table: "EntraDirectoryUsers", column: "LinkedTitanUserId");
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTickets_OrganizationId_Number", table: "HelpdeskTickets", columns: new[] { "OrganizationId", "Number" }, unique: true);
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTickets_OrganizationId_Status", table: "HelpdeskTickets", columns: new[] { "OrganizationId", "Status" });
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTickets_DeviceId", table: "HelpdeskTickets", column: "DeviceId");
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTickets_RequesterUserId", table: "HelpdeskTickets", column: "RequesterUserId");
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTicketComments_TicketId", table: "HelpdeskTicketComments", column: "TicketId");
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTicketComments_OrganizationId", table: "HelpdeskTicketComments", column: "OrganizationId");
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTicketEvents_TicketId", table: "HelpdeskTicketEvents", column: "TicketId");
        migrationBuilder.CreateIndex(name: "IX_HelpdeskTicketEvents_OrganizationId", table: "HelpdeskTicketEvents", column: "OrganizationId");
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropTable(name: "HelpdeskTicketComments");
        migrationBuilder.DropTable(name: "HelpdeskTicketEvents");
        migrationBuilder.DropTable(name: "HelpdeskTickets");
        migrationBuilder.DropTable(name: "HelpdeskQueues");
        migrationBuilder.DropTable(name: "EntraDirectoryUsers");
        migrationBuilder.DropTable(name: "EntraIdSettings");
    }
}
